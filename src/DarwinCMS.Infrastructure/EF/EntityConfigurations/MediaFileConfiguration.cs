...
/// <summary>
/// EF Core Fluent API configuration for the MediaFile entity.
/// Handles media-specific properties and constraints.
/// </summary>
public class MediaFileConfiguration : IEntityTypeConfiguration<MediaFile>
{
    /// <summary>
    /// Configures the EF Core mapping for the MediaFile entity.
    /// </summary>
    /// <param name="builder">The entity builder for MediaFile.</param>
