        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpireDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    OgTitle = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    OgImage = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    OgDescription = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    StructuredDataJsonLd = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    DisplayCondition = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Module = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsSystemAssigned = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_MenuId_DisplayOrder",
                table: "MenuItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteSettings_Key_LanguageCode",
                table: "SiteSettings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoredFiles_FilePath_FileName",
                table: "StoredFiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_UserId_RoleId_Module",
                table: "UserRoles",
                columns: new[] { "UserId", "RoleId", "Module" },
                unique: true,
                filter: "[Module] IS NOT NULL");
